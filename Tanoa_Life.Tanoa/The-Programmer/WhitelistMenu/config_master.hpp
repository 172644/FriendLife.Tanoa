    ...
    class categories { // One class inside = One button = One licenses list
        class companies {
            ...
            licenses[] = {
                ...
                {"Permis Bateau","boat"},
                {"Permis de Pilote","pilot"},
                {"Permis Poids Lourd","trucking"},
                {"Permis Moto","moto"},
            	{"Licence dépanneur","DEPANNEUR"},
                {"Licence DIR","DIR"},
                {"Vendeur Luxe","VL"},
                {"Vendeur Moto","VM"},
                {"License traitement pétrole","oil"},
                {"License traitement diament","diamond"},
                {"License traitement sel","salt"},
                {"License traitement sable","sand"},
                {"License traitement fer","iron"},
                {"License traitement cuivre","copper"},
                {"License traitement ciment","cement"},
                {"License traitement medmarijuana","medmarijuana"}
            };
        };
        ...
        class gangsters {
            ...
            licenses[] = {
                //{"Licence Rebelle","Rebel"}
            	{"Permis de conduire","driver"},
            	{"License de cocaine","cocaine"},
            	{"License de heroine","heroin"},
            	{"License de marijuana","marijuana"}
            };
        };
