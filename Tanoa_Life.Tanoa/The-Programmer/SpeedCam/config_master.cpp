...
class FC_Settings_SpeedCam {
	...
	pay_on_flashed = true; // Money directly debited from bank account if the driver is in excess speed. Default : true
	money_lost_per_infraction = 75; // Only if pay_on_flashed = true. Amount of money debited. Default : 75

	show_veh_speed = true; // Displays the speed of the vehicle in the overview. (1=True, 0=false). Default : true

	radar_radius = 15; // Radius of the speed camera. Default : 15
	...
	can_flash_medics = false; // If set to false, all the players in independent side will not be flashed even in excess speed. Default : true
