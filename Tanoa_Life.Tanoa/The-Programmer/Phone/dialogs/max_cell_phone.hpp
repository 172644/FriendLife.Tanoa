...
class max_cell_phone {
   ...
   class controls
   {
       ...
       class sendMSG : Life_RscButtonMenu
       {
           ...
           onbuttonclick = "hint format [""text : %1"",ctrlText 3004]; [0,(ctrlText 3003),(""Test messages"")] spawn max_phone_fnc_sendMSG;";
       ...
       class TextAdminButton : Life_RscButtonMenu
       {
           ...
           onbuttonclick = "[2,(ctrlText 3003),(ctrlText 3004)] spawn max_phone_fnc_sendMSG;";
           x = 0.493359375 * safezoneW + safezoneX;
       ...
       class AdminMsgAllButton : Life_RscButtonMenu
       {
           ...
           onbuttonclick = "[1,(ctrlText 3003),(ctrlText 3004)] spawn max_phone_fnc_sendMSG;";
           x = 0.493359375 * safezoneW + safezoneX;
       ...
       class call : Life_RscButtonMenu
       {
           idc = 5041;
           text = "";
           onbuttonclick = "[(ctrlText 3003)] spawn max_phone_fnc_sendCall;";
