...
class Max_Settings_Fourriere {
    ...
    condition_open_impound_of_everyone = "license_civ_DP"; // This is not necessarily a condition only for cops, you can set a condition to check if the player has a certain license for example. All the players that match this condition will be able to see and unimpound the vehicle of everyone in the impound. Put "" to desactivate
