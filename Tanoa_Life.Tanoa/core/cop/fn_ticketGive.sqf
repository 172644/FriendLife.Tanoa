...
[0,"STR_Cop_TicketGive",true,[player getVariable ["RP_ID",name player],[(parseNumber _val)] call life_fnc_numberText,life_ticket_unit getVariable ["RP_ID",name life_ticket_unit]]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
