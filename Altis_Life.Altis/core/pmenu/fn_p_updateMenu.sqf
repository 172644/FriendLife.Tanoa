...
_mstatus ctrlSetStructuredText parseText format ["<img size='1.3' image='\Assets\Data\icons\ico_bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='\Assets\Data\icons\ico_money.paa'/> <t size='0.8'>$%2</t>",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
